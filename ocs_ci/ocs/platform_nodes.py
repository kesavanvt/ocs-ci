...
class AZURENodes(NodesBase):
    ...
    def __init__(self):
        ...
        self.secret = config.ENV_DATA['azure_secret']
        self.tenant = config.ENV_DATA['azure_tenant']
        self.resource_group = config.ENV_DATA['azure_resource_group']
        self.azure = azure_utils.AZURE(self.subscription_id, self.client_id, self.secret, self.tenant, self.resource_group)
