...
* Have locally installed OCM CLI, follow [official documentation](https://github.com/openshift-online/ocm-cli).
* Have locally installed osde2e CLI, follow [official documentation](https://github.com/openshift/osde2e).
